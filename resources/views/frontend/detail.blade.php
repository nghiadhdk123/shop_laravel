                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-price">
                                        <ins>{{ number_format($product->price_sales) }} VND</ins> <del>{{ number_format($product->origin_price) }} VND</del>
                                    </div>    
                                    ...
                                    <div class="product-inner-category">
                                        <p>Hệ điều hành: <a href="">{{ $product->category->name }}</a>. Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>
                                    </div> 
